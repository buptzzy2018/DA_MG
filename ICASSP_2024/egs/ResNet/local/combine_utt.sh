...
if [ $stage -le 0 ]; then
    ...
    local/wav_to_duration.sh --nj ${get_dur_nj} ${statistics_dir}/wav.scp ${statistics_dir}/utt2dur
    ...
    local/utt2spk_to_spk2utt.pl ${statistics_dir}/utt2spk > ${statistics_dir}/spk2utt
fi
