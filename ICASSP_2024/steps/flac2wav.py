...
def flac2wav_main(flac_path):
    print(flac_path)
    wav_path = flac_path.strip("flac") + "wav"
    print(wav_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--speaker_level', help='speaker level', type=int, default=1)
